  ...
  properties: {
    ...
    configuration: {
      ...
      secrets: [
        ...
        {
          name: 'database-url'
          value: 'mssql+aioodbc://sqladmin:P%40ssw0rd123%21@${sqlServer.properties.fullyQualifiedDomainName}:1433/${sqlDatabase.name}?driver=ODBC+Driver+18+for+SQL+Server&Encrypt=yes&TrustServerCertificate=no&Connection+Timeout=30'
        }
        {
